  ...
  return (
    <div className="w-full block bg-white rounded-lg lg:flex p-2 mb-12">
      ...
      <div className="w-full lg:w-[50%] flex flex-col justify-center">
        <h2 className={`${styles.productTitle}`}>Iphone 14 Pro Max Special Deal</h2>
        <p>
          Limited time offer on the latest iPhone. Get the best performance and camera quality at a discounted price for a short period.
        </p>
